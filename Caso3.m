...
W4*(((2*pi*f)^4*m2^2*((2*pi*f)^2*x(1)^2+x(3)^2))*s/(m1*m2*(2*pi*f)^4+(x(1)*m2+x(2)*m1+x(2)*m2)*(2*pi*f)^3+(x(1)*x(2)+x(3)*m2+x(4)*m1+x(4)*m2)*(2*pi*f)^2+(x(1)*x(4)+x(2)*x(3))*(2*pi*f)+x(3)*x(4)))+....
W5*((m2^2*(2*pi*f)^4*(x(1)^2*(2*pi*f)^2+x(3)^2))/(m1*m2*(2*pi*f)^4+(x(1)*m2+x(2)*m1+x(2)*m2)*(2*pi*f)^3+(x(1)*x(2)+x(3)*m2+x(4)*m1+x(4)*m2)*(2*pi*f)^2+(x(1)*x(4)+x(2)*x(3))*(2*pi*f)+x(3)*x(4)))+....
W6*((16*m2^2*pi^4*s*(f-0)^4*(x(3)^2+4*x(1)^2*pi^2*(f-0)^2)*(2*pi*(x(1)*x(4)+x(2)*x(3))+4*pi^2*(2*f-2*0)*(x(1)*x(2)+x(3)*m2+x(4)*m1+x(4)*m2)+24*pi^3*(f-0)^2*(x(1)*m2+x(2)*m1+x(2)*m2)+64*m1*m2*pi^4*(f-0)^3))/(x(3)*x(4)+4*pi^2*(f-0)^2*(x(1)*x(2)+x(3)*m2+x(4)*m1+x(4)*m2)+8*pi^3*(f-0)^3*(x(1)*m2+x(2)*m1+x(2)*m2)+2*pi*(f-0)*(x(1)*x(4)+x(2)*x(3))+16*m1*m2*pi^4*(f-0)^4)^2-(64*m2^2*pi^4*s*(f-0)^3*(x(3)^2+4*x(1)^2*pi^2*(f-0)^2))/(x(3)*x(4)+4*pi^2*(f-0)^2*(x(1)*x(2)+x(3)*m2+x(4)*m1+x(4)*m2)+8*pi^3*(f-0)^3*(x(1)*m2+x(2)*m1+x(2)*m2)+2*pi*(f-0)*(x(1)*x(4)+x(2)*x(3))+16*m1*m2*pi^4*(f-0)^4)-(64*x(1)^2*m2^2*pi^6*s*(f-0)^4*(2*f-2*0))/(x(3)*x(4)+4*pi^2*(f-0)^2*(x(1)*x(2)+x(3)*m2+x(4)*m1+x(4)*m2)+8*pi^3*(f-0)^3*(x(1)*m2+x(2)*m1+x(2)*m2)+2*pi*(f-0)*(x(1)*x(4)+x(2)*x(3))+16*m1*m2*pi^4*(f-0)^4));
